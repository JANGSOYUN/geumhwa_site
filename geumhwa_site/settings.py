...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'geumhwa9300@naver.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '9037geumhwa!!')
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER

# 이메일 전송 실패 시 콘솔 백엔드로 대체 (개발 환경)
